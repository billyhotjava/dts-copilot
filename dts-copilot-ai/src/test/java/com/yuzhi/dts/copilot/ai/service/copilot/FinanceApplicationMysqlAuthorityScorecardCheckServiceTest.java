...
class FinanceApplicationMysqlAuthorityScorecardCheckServiceTest {

    @Test
    void convertsPassedApplicationMysqlProofIntoF2ScorecardCheck() {
        FinanceApplicationMysqlAuthorityScorecardCheckService service =
                new FinanceApplicationMysqlAuthorityScorecardCheckService();
        FinanceApplicationMysqlAuthorityProofRunner.RunResult runResult =
                new FinanceApplicationMysqlAuthorityProofRunner.RunResult(
                        "",
                        FinanceApplicationMysqlAuthorityProofRunner.RunStatus.PASSED,
                        "",
                        List.of(
    ...
    void convertsDisabledProofIntoPendingLiveEvidenceFailureWithoutFakingPass() {
        FinanceApplicationMysqlAuthorityScorecardCheckService service =
                new FinanceApplicationMysqlAuthorityScorecardCheckService();
        FinanceApplicationMysqlAuthorityProofRunner.RunResult disabled =
                new FinanceApplicationMysqlAuthorityProofRunner.RunResult(
                        "",
    ...
    void preservesApplicationMysqlProofDifferencesAsScorecardFailures() {
        FinanceApplicationMysqlAuthorityScorecardCheckService service =
                new FinanceApplicationMysqlAuthorityScorecardCheckService();
        FinanceApplicationMysqlAuthorityProofRunner.RunResult failed =
                new FinanceApplicationMysqlAuthorityProofRunner.RunResult(
                        "",
                        FinanceApplicationMysqlAuthorityProofRunner.RunStatus.FAILED,
    ...
    private static FinanceApplicationMysqlAuthorityProofService.ProofReport report(
            String caseId,
            boolean passed,
            String status,
            String difference) {
        ...
        return new FinanceApplicationMysqlAuthorityProofService.ProofReport(
                caseId,
                FinanceApplicationMysqlAuthorityProofService.AUTHORITY_SOURCE,
                passed,
                passed ? "" : "summary mismatch",
                reconciliation);
    }
