...
class FinanceApplicationMysqlOracleJdbcConfigurationTest {
    ...
    void shouldCreateApplicationMysqlOracleExecutorOnlyWhenEnabled() {
        ...
        contextRunner
                ...
                .run(context -> {
                    assertThat(context).hasSingleBean(FinanceApplicationMysqlOracleProofService.QueryExecutor.class);
                    FinanceApplicationMysqlOracleProofService.QueryExecutor executor =
                            context.getBean(FinanceApplicationMysqlOracleProofService.QueryExecutor.class);
