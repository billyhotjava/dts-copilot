...
class FinanceApplicationMysqlAuthorityJdbcConfigurationTest {
    ...
    void shouldCreateApplicationMysqlAuthorityExecutorOnlyWhenEnabledWithLegacyAlias() {
        contextRunner.run(context -> assertThat(context)
                .doesNotHaveBean(FinanceApplicationMysqlAuthorityProofService.QueryExecutor.class));
                ...
                .run(context -> {
                    ...
                    FinanceApplicationMysqlAuthorityProofService.QueryExecutor executor =
                            context.getBean(
                                    ...
                                    FinanceApplicationMysqlAuthorityProofService.QueryExecutor.class);
    ...
    void shouldPreferAuthorityNamedConfigurationForApplicationMysqlProof() {
        contextRunner
                ...
                .run(context -> {
                    ...
                    FinanceApplicationMysqlAuthorityProofService.QueryExecutor applicationExecutor =
                            context.getBean(
                                    "financeApplicationMysqlAuthorityJdbcQueryExecutor",
                                    FinanceApplicationMysqlAuthorityProofService.QueryExecutor.class);
