...
@ConditionalOnProperty(
        prefix = "copilot.finance.reconciliation.local-evidence",
        name = "enabled",
        havingValue = "true")
public class FinanceReconciliationScorecardLocalEvidenceProvider implements FinanceReconciliationScorecardEvidenceProvider {
    ...
    public FinanceReconciliationScorecardLocalEvidenceProvider(
