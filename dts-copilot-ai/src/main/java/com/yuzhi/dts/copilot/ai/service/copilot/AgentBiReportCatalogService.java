...
public class AgentBiReportCatalogService {
    ...
    private static final List<ReportCatalogEntry> ENTRIES = List.of(
            new ReportCatalogEntry(
                    ...
                    List.of("screen:prs-flowerbiz-overview-v1", "semantic-pack:flowerbiz"),
                    true),
            new ReportCatalogEntry(
            ...
            new ReportCatalogEntry(
                    ...
                    List.of("dbt-model:public.xycyl_ads_flowerbiz_baddebt_summary", "semantic-pack:flowerbiz"),
                    true),
            new ReportCatalogEntry(
                    ...
                    List.of("dbt-model:public.xycyl_ads_flowerbiz_pending", "semantic-pack:flowerbiz"),
                    true),
            new ReportCatalogEntry(
            ...
            new ReportCatalogEntry(
                    ...
                    "bar",
                    List.of("客户贡献", "客户", "项目", "排行", "排名", "价值"),
                    List.of("dbt-model:public.xycyl_dws_flowerbiz_customer_monthly", "semantic-pack:flowerbiz"),
                    true),
            new ReportCatalogEntry(
