...
public class AgentBiReportCatalogService {
    ...
    private static final List<ReportCatalogEntry> ENTRIES = List.of(
            ...
            new ReportCatalogEntry(
                    ...
                    "MEDIUM",
                    List.of("项目域 Sprint-25 dbt ADS，金额字段当前为 raw 合计，rent/cost 乘法口径待业务方拍板。"),
                    "table",
                    List.of("项目经营", "项目总览", "项目 TOP", "经营 TOP", "实摆排行", "绿植排行", "项目点", "实摆", "top"),
                    List.of("fixed-report:PRS-PROJECT-OVERVIEW", "dbt-model:public.xycyl_ads_project_overview", "semantic-pack:project"),
                    true),
            new ReportCatalogEntry(
                    "prs.project.green_change_monthly",
                    "project",
                    "FIXED_REPORT",
                    "L2_FIXED_REPORT",
                    "public.xycyl_ads_project_green_change_monthly",
                    "MEDIUM",
                    List.of("项目 x 月 x 实摆状态 ADS；默认按 pose_time 所属月份汇总。"),
                    "table",
                    List.of("绿植月报", "实摆月报", "月度实摆", "加减调换", "项目绿植变化", "状态月报"),
                    List.of("fixed-report:PRS-PROJECT-GREEN-CHANGE-MONTHLY", "dbt-model:public.xycyl_ads_project_green_change_monthly", "semantic-pack:project"),
                    true),
            new ReportCatalogEntry(
                    "prs.project.status_distribution",
                    "project",
                    "FIXED_REPORT",
                    "L2_FIXED_REPORT",
                    "public.xycyl_ads_project_status_dist",
                    "MEDIUM",
                    List.of("统一展示项目状态与实摆状态分布；状态标签来自 Sprint-25 dbt 状态维表。"),
                    "table",
                    List.of("项目状态", "实摆状态", "状态分布", "正常项目", "停用项目", "摆放中"),
                    List.of("fixed-report:PRS-PROJECT-STATUS-DIST", "dbt-model:public.xycyl_ads_project_status_dist", "semantic-pack:project"),
                    true),
            new ReportCatalogEntry(
                    "prs.project.contract_expiry_alert",
                    "project",
                    "FIXED_REPORT",
                    "L2_FIXED_REPORT",
                    "public.xycyl_ads_contract_expiry_alert",
                    "MEDIUM",
                    List.of("合同到期预警基于合同结束日期，默认不替代 adminweb 合同详情页面的最终确认。"),
                    "table",
                    List.of("合同到期", "快到期", "即将到期", "过期", "90天", "60天", "30天", "合同预警"),
                    List.of("fixed-report:PRS-PROJECT-CONTRACT-EXPIRY", "dbt-model:public.xycyl_ads_contract_expiry_alert", "semantic-pack:project"),
                    true),
            new ReportCatalogEntry(
