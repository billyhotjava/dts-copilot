...
public class BusinessObjectCatalogService {
    ...
    private static final List<BusinessObjectEntry> ENTRIES = List.of(
            ...
            entry(
                    ...
                    "prs.warehouse.stock_movement.profile",
                    "warehouse",
                    "仓库管理 > 库存/出入库",
                    "business-object:prs.warehouse.stock_movement",
                    List.of(
                            "仓库对象覆盖库存、入库、出库、调拨、报损和退货，适合做库存状态和出入库单据画像。",
                            "库存成本和周转经营分析应沉淀候选 ADS 后复用。"),
                    List.of("仓库", "物品", "规格", "库存数量", "库存状态", "入库单号", "出库单号", "调拨单号", "报损数量", "退货数量", "更新时间"),
                    List.of("库存状态分布", "物品库存排行", "入库出库统计", "调拨记录", "报损退货排查"),
                    List.of("仓库", "库存", "出入库", "入库", "出库", "调拨", "报损", "退货", "库存状态"),
                    List.of(
                            "business-object:prs.warehouse.stock_movement",
                            "adminweb:仓库管理/库存",
                            "adminweb:仓库管理/入库出库",
