...
public class BusinessObjectCatalogService {
    ...
    private static final List<BusinessObjectEntry> ENTRIES = List.of(
            ...
            entry(
                    ...
                    List.of("采购", "采购情况", "绿植采购", "各个绿植", "采购单", "采购汇总", "采购明细", "采购金额", "采购人", "自采", "市场采购", "供应商"),
                    List.of(
                            "business-object:prs.procurement.purchase_order",
                            "authority.procurement.purchase_item_detail",
                            "authority.procurement.purchase_amount_by_buyer",
            ...
            entry(
                    ...
                    List.of("配送记录", "配送", "接收人", "接收时间", "配送时间", "目的地", "起始", "采购配送"),
                    List.of(
                            "business-object:prs.procurement.delivery_record",
