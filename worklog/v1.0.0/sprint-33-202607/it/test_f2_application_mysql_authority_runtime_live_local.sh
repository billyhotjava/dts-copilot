...
COPILOT_FINANCE_APPLICATION_MYSQL_AUTHORITY_JDBC_URL="jdbc:mysql://${MYSQL_CONTAINER}:3306/${MYSQL_DATABASE}?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=Asia/Shanghai" \
COPILOT_FINANCE_APPLICATION_MYSQL_AUTHORITY_USERNAME=root \
COPILOT_FINANCE_APPLICATION_MYSQL_AUTHORITY_PASSWORD="$MYSQL_ROOT_PASSWORD" \
COPILOT_FINANCE_APPLICATION_MYSQL_AUTHORITY_DATABASE="$MYSQL_DATABASE" \
COPILOT_FINANCE_APPLICATION_MYSQL_AUTHORITY_COPILOT_JDBC_URL="jdbc:postgresql://${PROOF_PG_HOST}:${PROOF_PG_PORT}/${PROOF_PG_DATABASE}" \
COPILOT_FINANCE_APPLICATION_MYSQL_AUTHORITY_COPILOT_USERNAME="$PROOF_PG_USER" \
COPILOT_FINANCE_APPLICATION_MYSQL_AUTHORITY_COPILOT_PASSWORD="$PROOF_PG_PASSWORD" \
