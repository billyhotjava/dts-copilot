...
| IT-03 | 汇总双路对账 | F2-T02 | `it/test_f2_summary_dual_reconciliation.sh` | IN_PROGRESS（summary comparator + case registry + SQL 方言 contract PASS；live L2/签字 SQL vs copilot dataset 双路取数待接线） |
