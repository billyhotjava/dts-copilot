...
SELECT
  ...
  SUM(COALESCE(g.rent_amount_adminweb, 0))::numeric(18,2) AS rent_amount_adminweb_sum,
  SUM(COALESCE(g.cost_amount_adminweb, 0))::numeric(18,2) AS cost_amount_adminweb_sum,
  SUM(COALESCE(g.real_good_number_adminweb, 0))::numeric(18,2) AS real_good_number_adminweb_sum,
  SUM(COALESCE(g.green_number_adminweb, 0))::numeric(18,2) AS green_number_adminweb_sum,
  SUM(COALESCE(g.flowerpot_number_adminweb, 0))::numeric(18,2) AS flowerpot_number_adminweb_sum,
  SUM(COALESCE(g.flowerrack_number_adminweb, 0))::numeric(18,2) AS flowerrack_number_adminweb_sum,
